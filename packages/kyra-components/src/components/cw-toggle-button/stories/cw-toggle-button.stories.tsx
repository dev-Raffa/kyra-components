...
export const Default:StoryObj<cwToggleButtonArgs> = {
    ...Template,
    args:{
        unselectedBgColor:"#948383",
        unselectedColor: "#fffefe",
        selectedBgColor:"#d7d2d2",
...
export const Outline: StoryObj<cwToggleButtonArgs> = {
    ...Template,
    args: {
        unselectedBgColor:"transparent",
        unselectedColor:"#594b4b",
        selectedBgColor:"#594b4b",
        selectedColor: "#ddcece"
    },
    render: (args) => {
        return `
            <cw-toggle-button
...
export const Icon: StoryObj<cwToggleButtonArgs> = {
    ...Template,
    args:{
